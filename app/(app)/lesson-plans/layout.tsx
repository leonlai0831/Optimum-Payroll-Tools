...
/**
 * Lesson Plan section shell. Gated on the "swim" launcher category, then:
 * editors (`edit_lesson_plans`) create + manage their own plans; reviewers
 * (`review_lesson_plans`) see and review everyone's. Either capability opens
 * the section. Swim-School brand (the default skin).
 */
